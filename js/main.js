/*Detta körs först då hemsidan laddat färdigt*/
$(document).ready(function(){
	/*Kollar ifall det finns en session dvs att någon är inloggad, då visar den logut knappen och gömmer login knappen
	annars gömmer den logut(via ajax)*/
	$.ajax({
	...
	/*Jag gömmer sidan i html, sen visas den när sidan laddat färdigt.*/
	$("#hideTemplate").show();
	$("#hideChild").show();
});

/*Kollar lösenordskraven*/
function check(){
...
/*Skickar iväg start och sluttid får tillbaka tillgängliga barnvakter via ajax*/
function babysitter_received(){
	...
	xmlhttp.send(); //skickar iväg requesten
}

/*Skickar iväg start och sluttid får tillbaka tillgänglig läxhjälp via ajax och använder sig av JSON*/
